...
```bash
pnpm add @pooyagolchian/riyal
```

```ts
import { formatRiyal, RIYAL_UNICODE, addVAT } from "@pooyagolchian/riyal";
...
```tsx
import { RiyalSymbol, RiyalPrice } from "@pooyagolchian/riyal/react";
import "@pooyagolchian/riyal/css";
...
- Framework adapters: `@pooyagolchian/riyal/react`, `@pooyagolchian/riyal/react-native`, `@pooyagolchian/riyal/web-component`, `@pooyagolchian/riyal/next`, `@pooyagolchian/riyal/tailwind`, `@pooyagolchian/riyal/og`
...
├── packages/
│   ├── riyal-symbol/      # Published as `@pooyagolchian/riyal`
